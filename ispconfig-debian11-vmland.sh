...
echo -e 'deb http://repo.vmland.ru/security.debian.org/debian-security bullseye-security main non-free contrib\ndeb http://repo.vmland.ru/deb.debian.org/debian bullseye-updates main non-free contrib\ndeb http://repo.vmland.ru/deb.debian.org/debian bullseye main non-free contrib\ndeb http://repo.vmland.ru/deb.debian.org/debian bullseye-backports-sloppy main non-free contrib\ndeb http://repo.vmland.ru/deb.debian.org/debian bullseye-backports main non-free contrib\ndeb http://repo.vmland.ru/deb.debian.org/debian bullseye-proposed-updates main non-free contrib' > /etc/apt/sources.list
